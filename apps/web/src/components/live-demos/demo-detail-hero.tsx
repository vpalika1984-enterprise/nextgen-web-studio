...
* Renders optional status badges, source link, and brochure link when a
* demo record supplies them, so richer catalog entries render more without
* any change to this component.
*/
export function DemoDetailHero({ demo }: DemoDetailHeroProps) {
    const statusLabels = (demo.status ?? [])
